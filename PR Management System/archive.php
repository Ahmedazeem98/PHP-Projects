              ...
              <table class="table table-light">
                ...
                <?php while($doctor = $doctors->fetch_assoc()) : ?>
                  <tr>
                    ...
                    <td>
                      <a href="edit.php?id=<?php echo $doctor['id'];?>&action=1&page=archive"><button type="button" class="btn btn-secondary">Edit</button></a>
                      <a href="edit.php?id=<?php echo $doctor['id'];?>&action=2&page=archive"><button type="button" class="btn btn-secondary">Delete</button></a>
                    </td>
